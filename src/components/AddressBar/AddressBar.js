...
class AddressBar extends Component {
    constructor(props) {
        ...
        this.updateLocalIframeSrcVariable = this.updateLocalIframeSrcVariable.bind(this);
    }
    ...
    render() {
        return (
            <div className={cx('root')}>
                ...
                <input onKeyPress={this.inputKeyPressHandler} onInput={this.updateAddress} className={cx('input')} value={this.state.address} type="text"/>
                <button onClick={this.setIframeSrc} className={cx('submit')}>Submit</button>
            </div>
        );
    }
}
